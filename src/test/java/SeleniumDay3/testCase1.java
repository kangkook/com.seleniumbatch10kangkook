...
public void homePageTesting() {
    ...
    Boolean logoutButton = driver.findElement(By.xpath("//div[@id='page-36']/div/div/div/p[1]/a")).isDisplayed();
    ...
    driver.findElement(By.xpath("//*[@id=\"menu-item-224\"]/a")).sendKeys(Keys.ENTER);
    
    // clicking or sending keys to first testcase of the HomePage category
    driver.findElement(By.xpath("//*[@id=\"accordion-222-sub_row_1-0-1-0-0\"]/ul/li[1]/div[1]/a")).sendKeys(Keys.ENTER);
